...
export type RegisterProjectBodySchema = z.infer<
  typeof registerProjectBodySchema
>;

// Implementação da validação utilizando o esquema Zod
export class ZodRegisterProjectBodySchemaValidation
  implements Validation<RegisterProjectBodySchema>
{
  parse(input: object | undefined) {
    return registerProjectBodySchema.parse(input);
  }
}
